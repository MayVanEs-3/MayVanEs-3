...
class ClubManagement {
	...
	public static void main(String[] args) {
		...
		MembershipList list = new MembershipList(); // Inititalisierung der Klasse MembershipList
...
=======
		 ...
		 */
>>>>>>> 1830bbd69dfbd8b93d63fe8aeb59b67a506d0bd9
		...
		/**
		 * Aus der neuen Liste(zweite Liste) den Mitglied mit der MitgliederID 5 löschen
		 */
