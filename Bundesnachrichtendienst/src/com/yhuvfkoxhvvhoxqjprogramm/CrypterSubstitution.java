...
class CrypterSubstitution implements Crypter{
	 ...
	 */
		 ...
		 * @return 
		 */
		public void Verschluesselung1(String g) {
			if (g.length() == 26) {
		 ...
		 */
		public String verschluesseln1(String verschluesseln) {
		 ...
		 */
		// Funktioniert nicht
		public String entschluesseln1(String entschluesseln) {
			String entschluesselterText = "";
			String x = this.verschluesseln1(entschluesseln);
