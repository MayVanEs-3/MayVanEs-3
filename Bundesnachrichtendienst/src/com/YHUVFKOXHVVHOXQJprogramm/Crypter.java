...
public interface Crypter {
	/**
	 * Setzt die Verschlüsselung zurück. Diese Methode ist bei einigen
	 * Verfahren sinnvoll, bei denen eine Position im Schlüssel verwaltet wird,
	 * da diese beim Wechsel von Ver- auf Entschlüsselung zurückgesetzt werden
	 * muss.
	 */
	public void reset();
